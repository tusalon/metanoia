...
const CACHE_NAME = 'metanoia-v49';
const urlsToCache = [
  '/metanoia/',
  '/metanoia/index.html',
  '/metanoia/admin.html',
  '/metanoia/admin-login.html',
  '/metanoia/calendar.html',
  ...
  '/metanoia/vendor/react.production.min.js',
  '/metanoia/vendor/react-dom.production.min.js',
  '/metanoia/vendor/babel.min.js',
  '/metanoia/vendor/bcrypt.min.js',
  '/metanoia/vendor/tailwind-browser.js',
  '/metanoia/vendor/lucide/lucide.css',
  '/metanoia/vendor/lucide/lucide.woff2',
  '/metanoia/utils/push-config.js',
  '/metanoia/utils/push-notifications.js'
];
...
self.addEventListener('push', event => {
  ...
  const options = {
    ...
    icon: '/metanoia/icons/icon-192x192.png',
    badge: '/metanoia/icons/icon-96x96.png',
    tag: payload.tag || 'rservasroma',
    data: {
      url: payload.url || '/metanoia/admin.html',
      ...(payload.data || {})
    }
  };
...
self.addEventListener('notificationclick', event => {
  ...
  const targetUrl = event.notification?.data?.url || '/metanoia/admin.html';
  event.waitUntil(
